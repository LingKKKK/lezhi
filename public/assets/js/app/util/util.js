define(function() {
	...
	function dialog(args) {
		...
		$('.x-dialog-close,.x-dialog-btns .cancel', dialogWin).hover(function(){
		    $('.x-dialog-close,.x-dialog-btns .cancel img', dialogWin).css("transform","rotate(360deg)");
		},function(){
		    $('.x-dialog-close,.x-dialog-btns .cancel img', dialogWin).css("transform","rotate(0deg)");
		});
