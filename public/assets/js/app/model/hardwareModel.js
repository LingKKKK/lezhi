define(['app/util/compitableEvents', 'vendor/jsPlumb'], function(compitableEvents) {
	...
	function init(_container) {
		...
		// 	dragComponentDomDelete();
		// 	console.log(container.offsetWidth)
		// 	console.log(container.offsetHeight)
		// 	var rectDragX = dragComponentDom.style.left;
		// 	var rectDragY = dragComponentDom.style.top;
		// 	console.log(rectDragX)
		// 	console.log(rectDragY)
		// }, 30)

	};
	getSchema()
	function getSchema() {
		// console.dir(schema)   添加的所有模块信息
		return schema;
	}
	...
	function onDomMouseUp(e) {
		...
		var rect = recycleDom.getBoundingClientRect();
		if (e.pageX >= rect.left && e.pageY >= rect.top) {
			removeComponent(dragComponentDom)
		} else {
	...
	//  修改  拖拽放上时  回收站变颜色
	// // $('#hardware-container').mouseover(function(){
	// 	setInterval(function() {
	// 		document.getElementsByClassName('recycle')[0].style.color = 'black';
	// 		dragComponentDomDelete();
	// 	}, 500)
	// // })
	...
	// 		dragComponentDomDelete();
	// 	}, 500)
	// function dragComponentDomDelete() {
	// 	document.getElementsByClassName('recycle')[0].style.color = 'black';
	// 	var rectDragX = dragComponentDom.style.left;
	// 	var rectDragY = dragComponentDom.style.top;
	// 	var containerX = container.offsetWidth - 150 + 'px';
	// 	var containerY = container.offsetHeight - 150 + 'px';
	// 	if (rectDragX >= containerX && rectDragY >= containerY) {
	// 		document.getElementsByClassName('recycle')[0].style.color = 'blue';
	// 	} else {
	// 		document.getElementsByClassName('recycle')[0].style.color = 'black';
	// 	}
	// }
