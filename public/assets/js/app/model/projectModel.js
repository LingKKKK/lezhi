define(['vendor/jquery', './userModel', './hardwareModel'], function($1, userModel, hardwareModel) {
	var result;
	...
	// 	if ($('.blocks li:nth(96)').hasClass('active')) {
	...
	function getSchema() {
			...
			hardware: {
				boards: [{
					...
					pins: [{
							...
							y: 0.837,
							name: "3",
							tags: ["digital", "analog-out", "special"],
							overlay: [0.5, -0.5]
						}, {
							uid: "c297515b-2a2d-4b5c-96a8-e740d83a75ce",
							width: 33,
				...
				components: [{
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ac7419786c7",
						name: "Switch",
						label: "开关模块",
						type: "switch",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace419786c7",
						name: "LimitSwitch",
						label: "限位开关模块",
						type: "limitSwitch",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace429786c7",
						name: "Dht",
						label: "DHT 11数字温湿度传感器",
						type: "dht",
						category: "sensor",
						boards: ["KenBlock"],
						width: 72,
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4acea29786c7",
						name: "SoundSensor",
						label: "声音传感模块",
						type: "soundSensor",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4acea19786c7",
						name: "Fan",
						label: "风扇模块",
						type: "fan",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace418786c7",
						name: "PirMotion",
						label: "人体感知模块",
						type: "pirMotion",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace414786c7",
						name: "FlameSensor_D",
						label: "火焰传感模块",
						type: "flameSensor_D",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace41478ac7",
						name: "TiltSensor",
						label: "倾斜传感模块",
						type: "tiltSensor",
						category: "sensor",
						...
						uid: "bd3ddead-5062-4ab3-9b3d-2ba85e93cd0e",
						name: "Touch",
						label: "电容模块",
						type: "touch",
						category: "sensor",
						...
						uid: "bd3ddead-5062-4ab3-9b3d-2ba85e93ad0e",
						name: "AnalogTemp",
						label: "LM35模拟温度传感模块",
						type: "analogTemp",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace41878ac7",
						name: "TrackingSensor",
						label: "巡线传感模块",
						type: "trackingSensor",
						category: "sensor",
						...
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace4187eac7",
						name: "TrackingMatrix",
						label: "巡线阵列模块",
						type: "trackingMatrix",
						category: "sensor",
						...
						code: {
							include: '#include <RoSys.h>',
							var: 'RoLineTracking {NAME}({s});'
								// setup: 'pinMode({NAME}, INPUT);'
						}
					}, {
						uid: "bbf2233f-f9a8-4e95-8a1d-4ace4187ead7",
						name: "Motor",
						label: "电机模块",
						type: "motor",
						category: "action",
				...
				blocks: [{
					...
					// },
					{
						...
						connectors: [{
							...
							acceptType: "all",
							name: "4edce8d3-8232-4a19-a8f0-e5dd4b85f5f0"
						}],
						content: [{
							type: "text",
							value: "电机"
					...
					// ,
					{
						...
						connectors: [{
							...
							accept: "connector-output",
							acceptType: "all",
							name: "20a464bc-527f-4429-b21e-8dbea9404285"
						}],
						content: [{
							type: "text",
							value: "设置风扇"
						...
						tags: ["module"],
						module: "trackingSensor"
					}, {
						type: "output",
						name: "trackingMatrixRead1",
						connectors: [{
							type: "connector-output",
							accept: "connector-input"
						}],
						content: [{
							...
							id: "PIN",
							type: "dynamic-select",
							options: "trackingMatrixs"
						}, {
							type: "text",
							value: "的所有传感器的值"
						}],
						code: "{PIN}.readSensors()",
						returnType: {
							type: "simple",
							value: "float"
						},
						tags: ["module"],
						module: "trackingMatrix"
					}, {
						type: "output",
						name: "trackingMatrixRead2",
						connectors: [{
							type: "connector-output",
							accept: "connector-input"
						}],
		...
		var result = [];
		var oAll = document.getElementsByClassName('palette')[0];
		var oDiv = oAll.getElementsByClassName('paletteDom_div');

		$('.tab-software .palette .paletteDom_click1').on('click', ledMatrixData);
		$('.tab-software .palette .paletteDom_click2').on('click', clearup);

		function ledMatrixData() {
			var data = Array.from(oDiv).map(function(div) {
				return div.dataset.value;
			});
			var extradd = '\n/*"自定义"*/\nunsigned char Data_user[][8] ={' + data + '}\n';
			var dataUid = $(".hardware-container [data-name=LedMatrix]").attr("data-uid");
			var ledMartrixData = hardwareModel.getComponentData(dataUid);
			ledMartrixData.code.extradd = extradd;
			$('.palette').css('display', 'none');
			// console.log(extradd);
		}
		// console.dir($(".hardware-container [data-name=LedMatrix]").attr("data-uid"))

		function clearup() {
			var num_LED = 9;
			$('.tab-software .palette .paletteDom_div').css('background-color', 'white');
			$('.tab-software .palette .paletteDom_div').attr('data-value', '0');
			console.dir($('.block.block-statement.module.ACT009.modulebs').eq(9))
			$('.block.block-statement.module.ACT009.modulebs').eq(9).onclick(function() {
				console.log(1)
			})
			ledMatrixData();
		}
