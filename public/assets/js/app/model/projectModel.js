		...
		var schema = {
			hardware: {
				...
				components: [{
						...
						code: {
							include: '#include <RoSys.h>',
							extra: 'unsigned char Data_he[][8]=\r{\r{0x04,0x0E,0x78,0x08,0x08,0xFF,0x08,0x18},\r{0x1C,0x2A,0x2A,0x48,0x88,0x08,0x08,0x08},\r{0x00,0x00,0x00,0x7C,0x44,0x44,0x44,0x44},\r{0x44,0x44,0x44,0x44,0x7C,0x44,0x00,0x00},/*"和",0*/\r};\runsigned char Data_xin[][8]=\r	{\r{0x00,0x00,0x00,0x1E,0x3F,0x7F,0x7F,0x7F},\r{0x3F,0x1F,0x0F,0x07,0x03,0x01,0x00,0x00},\r{0x00,0x00,0x00,0x78,0xFC,0xFE,0xFE,0xFE},\r{0xFC,0xF8,0xF0,0xE0,0xC0,0x80,0x00,0x00},/*心形*/\r};',
