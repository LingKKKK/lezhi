define(['vendor/jquery', 'app/util/util', 'app/util/emitor', 'app/util/compitableEvents', 'app/model/hardwareModel', './software'], function($1, util, emitor, compitableEvents, hardwareModel, software) {
	var region;
	var filterList;
	var componentList;
	var search;
	...
	var componentTemplate = '<li data-filter="{{filter}}" data-label="{{label}}" data-name="{{name}}"><div class="hover change"><i class="icon lezhi lz-act001"></i></div><div class="image-wrap"><img class="image" draggable="false" src="{{src}}" /></div><div class="name">{{label}}</div></li>'
	...
	function init() {
		...
		// 	if ($('.pin-3').hasClass('jsplumb-endpoint-full') || $('.pin-9').hasClass('jsplumb-endpoint-full') || $('.pin-10').hasClass('jsplumb-endpoint-full') || $('.pin-11').hasClass('jsplumb-endpoint-full') || $('.tab-software .filters-wrap').find('.filters li:nth-child(1)').hasClass('active')) {
		...
		// 	$('.blocks li:nth(88)').css('display', 'none');
		// })
		// $('.filters li:nth-child(4)').click(function() {
		// 	$('.blocks li:nth(88)').css('display', 'none');
		// })
		// $('.filters li:nth-child(5)').click(function() {
		// 	$('.blocks li:nth(88)').css('display', 'none');
		// })
		// $('.filters li:nth-child(6)').click(function() {
		// 	$('.blocks li:nth(88)').css('display', 'none');
		// })
		// $('.filters li:nth-child(7)').click(function() {
		// 	$('.blocks li:nth(88)').css('display', 'none');
		// })
		// $('.filters li:nth-child(8)').click(function() {
		// 	$('.blocks li:nth(88)').css('display', 'none');
		// })
	...
	function getSoftwareCode() {
		var arrow = software.getCode(getBlockData());
	...
	function onComponentPreMouseMove(e) {
		...
		if (startPreMouseMove) {
			...
			// console.dir(dragContainer)  被拖拽的模块
